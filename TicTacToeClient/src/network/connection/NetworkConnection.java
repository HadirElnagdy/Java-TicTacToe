                    ...
                    try {
                        ...
                        if (json.has("key") && !json.get("key").isJsonNull()) {
                            ...
                            if ("signup".equals(keyValue)) {
                                ...
                                keyValue = json.get("key").getAsString();
                                System.out.println("key value: " + keyValue);
                               ...
                               if ("signup".equals(keyValue)) {
                                  ...
                                  if ("sign in successful".equals(str)) {
                                        ...
                                        Platform.runLater(() -> showAlert(Alert.AlertType.ERROR, "Invalid username or password"));
                                    }
                                } else {
                                    System.out.println("Unexpected 'key' value: " + keyValue);
                                }
                            } else {
                                System.out.println("Invalid JSON format: 'key' field is missing or null");
